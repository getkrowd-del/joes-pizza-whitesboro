...
const IMG = {
        ...
        const MENU_DATA = [
            /* ---------- PIZZAS ---------- */
            { title:"Cheese", desc:"Our classic NY-style cheese pie. Simple, iconic, and made fresh.", tag:"Best Seller", keepImg:true, category:"pizza", img:IMG.p1,
            ...
            { title:"Cheese & Peppers", desc:"Mozzarella with fresh peppers on our hand-tossed crust.", tag:"", category:"pizza", img:IMG.p1,
              prices:[{s:"Sm",cash:14.00,cc:14.53},{s:"Med",cash:17.00,cc:17.65},{s:"Lg",cash:21.00,cc:21.80}] },
            { title:"Cheese & Anchovies", desc:"A classic mozzarella pie topped with savory anchovies.", tag:"", category:"pizza", img:IMG.p2,
              prices:[{s:"Sm",cash:14.00,cc:14.53},{s:"Med",cash:17.00,cc:17.65},{s:"Lg",cash:21.00,cc:21.80}] },
            ...
            { title:"Cheese & Pepperoni", desc:"Whole milk mozzarella loaded with pepperoni on our signature crust.", tag:"Best Seller", keepImg:true, category:"pizza", img:IMG.p2,
              prices:[{s:"Sm",cash:14.00,cc:14.53},{s:"Med",cash:17.00,cc:17.65},{s:"Lg",cash:21.00,cc:21.80}] },
            ...
            /* ---------- JUMBO WINGS ---------- */
            { title:"Jumbo Wings - 10", desc:"Ten crispy jumbo wings, sauced to order.", price:14.00, cc:14.53, tag:"Fan Favorite", keepImg:true, category:"wings", img:"https://krowdimg.b-cdn.net/clients/joes-pizza-whitesboro/32_Clip0053.jpg" },
            ...
            /* ---------- FINGER FOODS ---------- */
            { title:"Cheese Sticks", desc:"Golden, gooey mozzarella sticks served hot with marinara.", price:9.00, cc:9.34, tag:"Shareable", keepImg:true, category:"fingers", img:"https://krowdimg.b-cdn.net/clients/joes-pizza-whitesboro/29_Clip0050.jpg" },
            ...
            { title:"Chicken Fingers", desc:"Hand-breaded chicken fingers, fried crisp.", price:10.00, cc:10.38, tag:"", keepImg:true, category:"fingers", img:"https://krowdimg.b-cdn.net/clients/joes-pizza-whitesboro/30_Clip0051.jpg" },
                ...
                card.innerHTML = `
                    ...
                    <div class="p-7 space-y-3">
                        <div class="flex items-start gap-3 flex-wrap">
                            <h4 class="font-serif text-2xl font-bold text-warmCream-900 leading-tight">${item.title}</h4>
                            ${item.tag ? `<span class="inline-flex items-center bg-pizzaGold-500 text-white text-xs font-extrabold px-3.5 py-1.5 rounded-full uppercase tracking-wider border border-white/20 shadow-sm mt-1">${item.tag}</span>` : ''}
                        </div>
                        <p class="text-warmCream-800 text-base leading-relaxed font-medium">${item.desc}</p>
                        ${priceBlock(item)}
                    </div>`}
