                ...
                card.innerHTML = `
                    <div>
                        <div class="h-52 relative overflow-hidden bg-warmCream-200">
                            <img src="${item.img}" class="w-full h-full object-cover" alt="${item.title} — Joe's Pizza Yorkville" onerror="this.src='https://placehold.co/400x300/f4efea/4e3629?text=${encodeURIComponent(item.title)}'">
